  ...
  providers: [
    ...
    providePrimeNG({
      theme: {
        preset: Lara,
        options: {
          // The Obsidian design system owns light/dark via [data-theme]; disable
          // PrimeNG's own dark palette so it never competes with the token contract.
          darkModeSelector: false,
          // Sink PrimeNG's generated CSS into a named layer; the wrappers' un-layered
          // ::ng-deep overrides + --obs-*/--color-* tokens always win without !important.
